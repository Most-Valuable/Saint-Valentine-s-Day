function showTime() { 
	...
	var startDate = new Date(2020, 10, 27,23,25);
	...
	if (seconds < 10) 
	seconds = "0" + seconds; 
	var currentTimeString = "<br>"+"<br>"+"<br>"
        +"Dear Yuqi:<br>"
		...
		+ "&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp以后，就是我的家人啦，不准离开我噢. <br>"
		+ "&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp"
		+	"<c style=\"color: #ffff00; text-shadow:2px 3px 3px #222; font-family:Microsoft YaHei; font-size:20px\" >----你的宝贝   2021-02-14 </c>"; 
